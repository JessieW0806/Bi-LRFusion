...
radar_cloud_range = [-51.2, -51.2, -5.0, 51.2, 51.2, 3.0]
...
filter_by_min_points=dict(car=5, motorcycle=5, )
sample_groups=dict(car=2, motorcycle=6,)
...
model = dict(
    ...
    radar_middle_encoder=dict(
        type='PointPillarsScatter', in_channels=32+32, output_shape=(128, 128)),
    ...
    fusion_head = dict( layers = 3, in_channels=512+64, out_channels=512,),
...
log_level = 'INFO'
work_dir = './work_dirs/7bevfusion+fz' #2class_bevfusion #2class_bevfusionffff
load_from = None
resume_from = None#'./work_dirs/voxel0.1sum/epoch_7.pth'
workflow = [('train', 1)]
db_sampler = dict(
    data_root=data_root,
    info_path=data_root+'nuscenes_dbinfos_train.pkl',
